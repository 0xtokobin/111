<template><div><p>本章节重在讲解模板编译与指令绑定，串联其他源码内容，因此代码功能实现暂不考虑</p>
<h2 id="class-vue-的创建" tabindex="-1"><a class="header-anchor" href="#class-vue-的创建" aria-hidden="true">#</a> class-Vue 的创建</h2>
<p>要点：</p>
<ol>
<li>各项配置和 data 初始化，data 数据修改为响应式</li>
<li>初始化 data、computed、watch 三大依赖收集器</li>
<li>执行模板编译</li>
</ol>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">class</span> <span class="token class-name">Vue</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="compile-编译类的创建" tabindex="-1"><a class="header-anchor" href="#compile-编译类的创建" aria-hidden="true">#</a> Compile 编译类的创建</h2>
<p>要点：</p>
<ol>
<li>编译三部曲：获取 dom(this.node2Fragment)、编译 dom(this.compile)、回填 dom(appendChild)</li>
<li>重点编译 dom 的步骤：fragment 节点内部递归遍历子节点，为插值语法追加 Watcher 监听，识别<code v-pre>v-</code>、<code v-pre>@</code>等指令，绑定对应节点</li>
<li><code v-pre>v-model</code>指令需要注意双向绑定实现，借助 Watcher 的回调实现数据影响视图，并添加 input 事件监听器反向修改数据实现视图影响数据</li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// compile.js</span>
...
<ol>
<li>模板编译的执行顺序在初始化依赖收集系统之后，虚拟 DOM 的 render 渲染之前</li>
<li>模板编译侧重于对已有 DOM 节点的获取、编译转化与重新回填</li>
<li>编译转化时的逻辑侧重于插值语法的内容替换以及自定义指令的绑定</li>
<li>在 SPA 项目开发中不涉及模板编译步骤，因为根元素 el 为 div 空节点</li>
<li>模板编译主要用于传统的 cdn 写法和 ssr 服务端渲染的元素节点构建</li>
</ol>
</div></template>
