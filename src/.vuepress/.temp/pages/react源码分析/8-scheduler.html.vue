<template><div><h2 id="messagechannel" tabindex="-1"><a class="header-anchor" href="#messagechannel" aria-hidden="true">#</a> MessageChannel</h2>
<p>在上面的源码中，我们使用 requestIdleCallback 来实现浏览器帧渲染与 JS 优化，但是目前 requestIdleCallback 的浏览器兼容性比较差</p>
<p>所以目前 React 利用 MessageChannel 模拟了 requestIdleCallback，将回调延迟到绘制操作之后执行</p>
<p>MessageChannel API 允许我们创建一个新的消息通道，并通过它的两个 MessagePort 属性发送数据</p>
<p>MessageChannel 创建了一个通信的管道，这个管道有两个端口，每个端口都可以通过 postMessage 发送数据，而一个端口只要绑定了 onmessage 回调方法，就可以接收从另一个端口传过来的数据</p>
<p>MessageChannel 是一个宏任务</p>
<figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/liu_lan_qi_zhen.jpg" alt="MessageChannel" tabindex="0" loading="lazy"><figcaption>MessageChannel</figcaption></figure>
<p>以下是一个 MessageChannel 的代码示例</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> channel <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">MessageChannel</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<h3 id="二叉树简介" tabindex="-1"><a class="header-anchor" href="#二叉树简介" aria-hidden="true">#</a> 二叉树简介</h3>
<p>二叉树：每个节点最多有两个子节点</p>
<p>满二叉树：除最后一层无任何子节点外，每一层上的所有节点都有两个子节点的二叉树</p>
<figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/manerchashu.jpg" alt="满二叉树" tabindex="0" loading="lazy"><figcaption>满二叉树</figcaption></figure>
<p>完全二叉树：</p>
<ul>
<li>叶子节点只能出现在最下层和次下层</li>
<li>且最下层的叶子节点集中在树的左部</li>
</ul>
<figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/wanquanerchashu.jpg" alt="完全二叉树" tabindex="0" loading="lazy"><figcaption>完全二叉树</figcaption></figure>
<h3 id="最小堆机制" tabindex="-1"><a class="header-anchor" href="#最小堆机制" aria-hidden="true">#</a> 最小堆机制</h3>
<ul>
<li>最小堆是一种经过排序的完全二叉树</li>
<li>其中任一非终端节点的数据均不大于其左子节点和右子节点的值</li>
<li>根节点值是所有堆节点值中的最小值</li>
<li>编号关系：
<ul>
<li>左子节点编号 = 父节点编号 x 2</li>
...
<li>索引关系
<ul>
<li>左子节点索引 = (父节点索引 + 1) x 2 - 1</li>
<li>右子节点索引 = 左子节点索引 + 1</li>
<li>父节点索引 = (子节点索引 - 1) / 2</li>
</ul>
</li>
</ul>
<figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/zui_xiao_dui_1_1643275468911.jpg" alt="最小堆" tabindex="0" loading="lazy"><figcaption>最小堆</figcaption></figure>
<p>使用最小堆的原因：</p>
<ol>
<li>设定任务队列，任务优先级越高，编号值越小</li>
<li>使推入最小堆中的任务队列永远是优先级最高的任务对象拍在顶点，永远取出优先级最高的任务</li>
</ol>
<h3 id="schedulerminheap-js" tabindex="-1"><a class="header-anchor" href="#schedulerminheap-js" aria-hidden="true">#</a> SchedulerMinHeap.js</h3>
<p>方法简析</p>
<ul>
<li>peek：查看堆的顶点</li>
<li>pop：弹出堆的顶点后需要调用 siftDown 函数向下调整堆</li>
<li>push：添加新节点后需要调用 siftUp 函数向上调整堆</li>
<li>siftDown：向下调整堆结构，保证最小堆</li>
<li>siftUp：向上调整堆结构，保证最小堆</li>
</ul>
<p>react\packages\scheduler\src\SchedulerMinHeap.js</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 最小堆方法</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="时间调度与优先级" tabindex="-1"><a class="header-anchor" href="#时间调度与优先级" aria-hidden="true">#</a> 时间调度与优先级</h2>
<p>需要引入各类优先级常量，建立最小堆，管理队列任务，在<RouterLink to="/react%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90/2-fiber.html#requestIdleCallback">fiber-requestIdleCallback</RouterLink>中通过 requestIdleCallback 实现的方法重新实现</p>
<figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/shi_jian_qie_pian_diao_du_1643278352662.jpg" alt="时间切片" tabindex="0" loading="lazy"><figcaption>时间切片</figcaption></figure>
<figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/React/duo_ge_ren_wu_1643279818108.jpg" alt="多任务队列" tabindex="0" loading="lazy"><figcaption>多任务队列</figcaption></figure>
<h3 id="schedulerpriorities-js" tabindex="-1"><a class="header-anchor" href="#schedulerpriorities-js" aria-hidden="true">#</a> SchedulerPriorities.js</h3>
<p>src\scheduler\src\SchedulerPriorities.js</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">const</span> NoPriority <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="scheduler-js" tabindex="-1"><a class="header-anchor" href="#scheduler-js" aria-hidden="true">#</a> Scheduler.js</h3>
<p>src\scheduler\src\forks\Scheduler.js</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> peek<span class="token punctuation">,</span> pop<span class="token punctuation">,</span> push <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"./SchedulerMinHeap"</span><span class="token punctuation">;</span>
...
<p>替换了原来的老 scheduleCallback 函数，更新了传入参数</p>
<p>加入 workLoopConcurrent 模式，与 workLoopSync 的区别是增加了判断 5ms 时间片逻辑</p>
...
<p><a href="https://github.com/mi-saka10032/mini-react/tree/master/packages/messageChannel" target="_blank" rel="noopener noreferrer">https://github.com/mi-saka10032/mini-react/tree/master/packages/messageChannel<ExternalLinkIcon/></a></p>
</div></template>
