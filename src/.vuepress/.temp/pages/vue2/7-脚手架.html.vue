<template><div><p>脚手架以vue-cli为例进行记录，实际开发更推荐使用vite。</p>
<h2 id="初始化脚手架" tabindex="-1"><a class="header-anchor" href="#初始化脚手架" aria-hidden="true">#</a> 初始化脚手架</h2>
<ol>
<li>
...
<li>
<p>文档: <a href="https://cli.vuejs.org/zh/%E3%80%82" target="_blank" rel="noopener noreferrer">https://cli.vuejs.org/zh/。<ExternalLinkIcon/></a></p>
</li>
</ol>
...
<p>第三步：启动项目</p>
<p>npm run serve</p>
<p>Vue 脚手架隐藏了所有 webpack 相关的配置，若想查看具体的 webpack 配置，请执行：vue inspect &gt; output.js</p>
<h3 id="模板项目结构" tabindex="-1"><a class="header-anchor" href="#模板项目结构" aria-hidden="true">#</a> 模板项目结构</h3>
<figure><img src="https://misaka10032.oss-cn-chengdu.aliyuncs.com/Vue/image-20211020165600263.png" alt="脚手架模板项目结构" tabindex="0" loading="lazy"><figcaption>脚手架模板项目结构</figcaption></figure>
<h2 id="请求代理" tabindex="-1"><a class="header-anchor" href="#请求代理" aria-hidden="true">#</a> 请求代理</h2>
<p>第一种方式：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>仅限一个服务器端口有效。</p>
<p>工作方式：请求了前端不存在的资源时，那么请求会转发给该服务器（优先匹配前端资源）</p>
<p>第二种方式：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">devServer</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以配置多个代理，且可以灵活控制请求是否走代理。</p>
<p>配置略微繁琐，请求资源时必须加前缀。</p>
</div></template>
