<template><div><p>注意，本章主要以类式组件为例，记录 React 中的核心属性与方法</p>
...
<ul>
<li>方案一：强制绑定 this，通过函数对象的 bind()</li>
<li>方案二：箭头函数</li>
</ul>
<h3 id="更新" tabindex="-1"><a class="header-anchor" href="#更新" aria-hidden="true">#</a> 更新</h3>
<p>state 中存放的是状态数据，不能直接修改或更新</p>
<p>需使用原型方法<code v-pre>setState()</code>来切换状态，<code v-pre>this.setState({ flag: 'xxx' })</code>，属于状态对象合并</p>
<h3 id="component-组件示例" tabindex="-1"><a class="header-anchor" href="#component-组件示例" aria-hidden="true">#</a> Component 组件示例</h3>
...
<h3 id="描述-1" tabindex="-1"><a class="header-anchor" href="#描述-1" aria-hidden="true">#</a> 描述</h3>
<p>每个组件对象都会有 props(properties)属性</p>
<p>组件标签的所有属性都保存在 props 中</p>
<h3 id="注意-1" tabindex="-1"><a class="header-anchor" href="#注意-1" aria-hidden="true">#</a> 注意</h3>
<p>props 是通过标签属性从组件外部向组件内部传递变化的数据（自上而下的数据通信）</p>
<p>子组件内部不要修改 props 数据</p>
<h3 id="操作" tabindex="-1"><a class="header-anchor" href="#操作" aria-hidden="true">#</a> 操作</h3>
<ol>
<li>子组件读取 props</li>
</ol>
<p><a href="http://this.props.name" target="_blank" rel="noopener noreferrer">this.props.name<ExternalLinkIcon/></a></p>
<ol start="2">
<li>对 props 中的属性值进行类型限制和必要性限制</li>
</ol>
<p>第一种方式（弃用）</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 类名外部写法</span>
...
<span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第二种方式（推荐，使用 prop-types 库进限制（需要引入 prop-types 库））</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 类名外部写法</span>
Person<span class="token punctuation">.</span>propTypes <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>Person<span class="token punctuation">.</span>defaultProps <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 组件初始化时可以对props进行操作</span>
...
<li>函数式组件可传入 props，但不可使用 state 属性</li>
</ol>
<div class="language-jsx line-numbers-mode" data-ext="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">function</span> <span class="token function">App</span><span class="token punctuation">(</span><span class="token parameter">props</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="component-组件示例-1" tabindex="-1"><a class="header-anchor" href="#component-组件示例-1" aria-hidden="true">#</a> Component 组件示例</h3>
...
<h3 id="描述-2" tabindex="-1"><a class="header-anchor" href="#描述-2" aria-hidden="true">#</a> 描述</h3>
<p>组件内的标签可以定义 ref 属性来标识自己</p>
<h3 id="注意-2" tabindex="-1"><a class="header-anchor" href="#注意-2" aria-hidden="true">#</a> 注意</h3>
<p>在 render 函数中，ref 指向的组件如<code v-pre>this.refs.xxx</code>为 undefined，因为此时组件尚未挂载，ref 指向为空</p>
<h3 id="操作-1" tabindex="-1"><a class="header-anchor" href="#操作-1" aria-hidden="true">#</a> 操作</h3>
<ol>
<li>字符串形式的 ref（建议弃用）</li>
</ol>
<p><code v-pre>&lt;input ref=&quot;input1&quot; /&gt;</code></p>
<ol start="2">
<li>回调形式的 ref</li>
</ol>
<p><code v-pre>&lt;input ref={(c)=&gt;{this.input1 = c}}&gt;</code></p>
<ol start="3">
<li>createRef 创建的 ref 容器（建议使用）</li>
</ol>
<p>myRef = React.createRef()</p>
<p><code v-pre>&lt;input ref={ this.myRef } /&gt;</code></p>
<h3 id="component-组件示例-2" tabindex="-1"><a class="header-anchor" href="#component-组件示例-2" aria-hidden="true">#</a> Component 组件示例</h3>
<div class="language-jsx line-numbers-mode" data-ext="jsx"><pre v-pre class="language-jsx"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> Component<span class="token punctuation">,</span> createRef <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react"</span><span class="token punctuation">;</span>
...
<p>render 调用 N+1 次，第一次为初始化，每次修改调用都会重新调用 render</p>
<p>state 执行 N 次，render 初始化时赋值 state 初始值，每次修改都会重新设置 state（如果 state 涉及修改的话）</p>
<p>props 受父组件影响，父组件执行 N 次则 props 执行 N 次（如果 props 涉及修改的话）</p>
<p>回调 ref 以内联函数的方式定义，在更新过程中被执行两次，第一个传入参数为 null，第二次再传入 DOM 元素。所以目前最推荐的还是<code v-pre>React.createRef()</code>方法</p>
</div></template>
